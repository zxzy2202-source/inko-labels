...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://inkolabels.com/ja/products" },
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {industryProducts.map((p) => (
              <Link key={p.slug} href={`/ja/products/${p.slug}`} className="bg-white rounded-xl p-4 text-center shadow-sm hover:shadow-md hover:border-[#E8A020] border border-transparent transition-all">
