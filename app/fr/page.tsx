...
const productCategories = [
  { name: "Cosmetic Labels", href: "/fr/products/cosmetic-labels", img: "/manus-storage/product-cosmetic-labels_3696937e.jpg" },
  { name: "Food Labels", href: "/fr/products/food-labels", img: "/manus-storage/product-food-labels_1701c8ab.jpg" },
  { name: "Beverage Labels", href: "/fr/products/beverage-labels", img: "/manus-storage/product-hero-beverage.jpg" },
  { name: "Pet Food Labels", href: "/fr/products/pet-food-labels", img: "/manus-storage/product-petfood-labels_ecc6466e.jpg" },
  { name: "Supplement Labels", href: "/fr/products/supplement-labels", img: "/manus-storage/product-supplement-labels_0b224cc0.jpg" },
  { name: "Essential Oil Labels", href: "/fr/products/essential-oil-labels", img: "/manus-storage/product-essential-oil-labels_ba7458ab.jpg" },
];
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/fr/products" className="inline-flex items-center gap-2 border-2 border-white/30 text-white font-bold px-8 py-4 rounded-full hover:border-white transition-colors text-lg">
                  {t.home.heroCta2}
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/fr/products" className="inline-flex items-center gap-2 bg-[#0F2744] text-white font-bold px-8 py-3 rounded-full hover:bg-[#1a3a5c] transition-colors">
      ...
      <section className="py-20 bg-[#0F2744]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link href="/fr/contact" className="inline-flex items-center gap-2 bg-[#E8A020] text-white font-bold px-10 py-4 rounded-full hover:bg-[#d4911c] transition-colors text-lg">
